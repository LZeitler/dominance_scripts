...
## install.packages(c("data.table","ggplot2","cowplot","grid","viridis","colorspace","reshape2","ggrepel","RColorBrewer","rio","ddpcr","readxl","lubridate","patchwork","forcats","scales")) 
...
mynow <- function() format(lubridate::now(),"%Y%m%d%H%M%S")
